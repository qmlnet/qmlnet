...
public:
    ...
    typedef void (SWIGSTDCALL* SWIG_Callback2_t)(char *, void *);
    void swig_connect_director(SWIG_Callback0_t callbackisValidType, SWIG_Callback1_t callbackBuildTypeInfo, SWIG_Callback2_t callbackCreateInstance);
